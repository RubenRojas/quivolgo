...
if(!in_array("3", $pUser)){
	...
	$_SESSION['error']['location'] = "/quivolgo/app_componente/index.php";
...
$query = "select * from app_componente where id='$id' limit 1";
	...
	<form action="forms/edit.php" method="post">
		<div class="row">
			...
			<div class="col s4">
				...
				<input type="text" name="descripcion" value="<?=$user['descripcion']?>">
			</div>
