...
$titulo ="Editar Campo Origen";

$query = "select * from app_rango where id='$id' limit 1";
	...
	<form action="forms/edit.php" method="post">
		<div class="row">
			...
			<div class="col s4">
				...
				<input type="number" name="valor_inicial" value="<?=$user['valor_inicial']?>">
			</div>
			<div class="col s4">
				<label for="">Valor Final</label>
				<input type="number" name="valor_final" value="<?=$user['valor_final']?>">
			</div>
