...
if(!in_array("3", $pUser)){
	...
	$_SESSION['error']['location'] = "/quivolgo/app_medio_aplicacion/index.php";
...
$titulo ="Editar Medio Aplicacion";

$query = "select * from app_medio_aplicacion where id='$id' limit 1";
