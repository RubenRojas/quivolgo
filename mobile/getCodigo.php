...
instalacion_parcela.id 
from instalacion_parcela 
inner join instalacion on instalacion.id = instalacion_parcela.id_instalacion 

where 
instalacion_parcela.codigo='$codigo' 
and instalacion.estado='1'
and instalacion.temporada <> '1'
and instalacion.id not in(select id_instalacion from inventario_medicion)
