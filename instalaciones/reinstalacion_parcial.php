...
$titulo = "Reinstalacion Parcial";

?>


<div class="container_form">
	<form action="forms/reinstalacion_parcial.php" method="post">
		<div class="row" id="form_instalacion">
			...
			<div class="row">
				...
				<div class="col s3">
					<label for="">Fecha Reinstalacion</label>
				...
				<div class="col s3">
					<label for="">Cant Contenedores</label>
					<input type="number" name="cant_contenedores" id="cant_contenedores" onchange="setNuevoNipla(this.value)">
				</div>
				...
				<div class="col s3">
					...
					<span class="dato" id="tipo_bandeja"></span>
				</div>
...
<script>
	var cap_contenedor = 0;
	function setNuevoNipla(val){
		console.log(cap_contenedor);
		console.log(val);
		$("#nipla").html(val * cap_contenedor);
		console.log("NUEVO NIPLA: "+(val * cap_contenedor));
	}
