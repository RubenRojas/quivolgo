...
if(!in_array("4", $pUser)){
	...
	$_SESSION['error']['location'] = "/quivolgo/app_categoria_aplicacion/index.php";
...
$titulo ="Borrar Categoria Aplicacion";

$query = "select * from app_categoria_aplicacion where id='$id' limit 1";
